    ...
    >
      {member.photo ? (
        <Image
          ...
          style={{ filter: isActive ? "grayscale(0) brightness(1)" : "grayscale(0) brightness(0.85)", objectPosition: member.objectPosition ?? "top", transform: `scale(${member.photoScale ?? 1})`, transformOrigin: "center top" }}
        />
      ) : (
